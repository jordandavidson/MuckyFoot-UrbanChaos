...
CBYTE *sound_list[] = {
    ...
    " *DL* GeneralMusic\\AlbTks\\BleepTune.wav",
    " *DL* GeneralMusic\\AlbTks\\OomaGabba.wav",
    " *DL* GeneralMusic\\AlbTks\\FeelinIt.wav",
    " *DL* GeneralMusic\\AlbTks\\BinaryFinary.wav",
    " *DL* GeneralMusic\\AlbTks\\TourDeForce.wav",
    "JudoChop1.wav",
    "MIBexplo1.wav",
    " *DL* MIBlevitate1.wav",
