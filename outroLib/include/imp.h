...
IMP_Mesh IMP_load(const CBYTE *fname, float scale = 1.0F);
...
SLONG    IMP_binary_save(const CBYTE *fname, IMP_Mesh *im);	// Returns FALSE on failure.
IMP_Mesh IMP_binary_load(const CBYTE *fname);
