...
void MAIN_main()
{
	...
	while(1)
	{
		...
		if (the_end)
		{
			...
			{
				FONT_draw(FONT_FLAG_JUSTIFY_CENTRE, 0.503F, 0.403F, 0x000000, 1.5F, -1, shimmer, (CBYTE*)"THE END");
				FONT_draw(FONT_FLAG_JUSTIFY_CENTRE, 0.500F, 0.400F, 0xffffff, 1.5F, -1, shimmer, (CBYTE*)"THE END");
			}
		}
