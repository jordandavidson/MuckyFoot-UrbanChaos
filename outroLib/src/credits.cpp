...
const CBYTE *CREDITS_eidos_france[] =
{
	"~BChef de produit",
	"\tOlivier Salomon",
	NULL,
...
const CBYTE *CREDITS_eidos_germany[] =
{
...
const CBYTE *CREDITS_voice_production[] =
{
	"~BCasting",
